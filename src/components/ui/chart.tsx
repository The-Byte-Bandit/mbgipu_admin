...
//         ? labelFormatter(item.value, payload)
//         : itemConfig?.label || item.name;

//       return value ? <div className={cn("font-medium", labelClassName)}>{value}</div> : null;
//     }, [hideLabel, payload, labelFormatter, labelClassName, config, labelKey]);
...
//   return config[configKey as keyof ChartConfig] || config[key as keyof ChartConfig];
// }
